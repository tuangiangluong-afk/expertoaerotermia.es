...
export default async function middleware(req: NextRequest) {
    ...
    // Get hostname (e.g. bornerechargeparis.fr, expertpompeachaleur.com)
    let hostname = req.headers.get("host") || "expertpompeachaleur.com";
    ...
    if (cleanPath.startsWith("/guides") || cleanPath.startsWith("/solutions") || cleanPath.startsWith("/service") || cleanPath.startsWith("/poi") || cleanPath.startsWith("/outils") || cleanPath.startsWith("/installation")) {
        response.headers.set("x-irve-canonical-domain", "www.expertpompeachaleur.com");
    } else {
