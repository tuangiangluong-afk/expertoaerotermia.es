...
// Expert Pompe à Chaleur - Couverture Nationale pSEO
// ========================================
...
export const NATIONAL_TARGETS: NationalTarget[] = [
    ...
    // ========================================
    {
        ...
        zip: "64000",
        tier: 'STRATEGIC',
        heroImage: "https://images.unsplash.com/photo-1594818379496-da1e345b0cd3?q=80&w=2670&auto=format&fit=crop"
    },
    {
        slug: "bayonne",
        name: "Bayonne",
        ...
        zip: "64100",
        tier: 'STRATEGIC',
        heroImage: "https://images.unsplash.com/photo-1592833159155-c62df1b65634?q=80&w=2670&auto=format&fit=crop"
    },
    {
        slug: "biarritz",
        name: "Biarritz",
        ...
        zip: "64200",
        tier: 'STRATEGIC',
        heroImage: "https://images.unsplash.com/photo-1542332213-9b5a5a3f8c47?q=80&w=2670&auto=format&fit=crop"
    },
    {
        slug: "tarbes",
        name: "Tarbes",
        ...
        zip: "65000",
        tier: 'STRATEGIC',
        heroImage: "https://images.unsplash.com/photo-1548613053-220bfd5e21b0?q=80&w=2670&auto=format&fit=crop"
    },
    {
        slug: "agen",
        name: "Agen",
        ...
        zip: "47000",
        tier: 'STRATEGIC',
        heroImage: "https://images.unsplash.com/photo-1558441719-ff34b0524a24?q=80&w=2670&auto=format&fit=crop"
    },
    {
        slug: "montauban",
        name: "Montauban",
        ...
        zip: "82000",
        tier: 'STRATEGIC',
        heroImage: "https://images.unsplash.com/photo-1618919716433-241088a74e6f?q=80&w=2670&auto=format&fit=crop"
    },
    {
        slug: "albi",
        name: "Albi",
        ...
        zip: "81000",
        tier: 'STRATEGIC',
        heroImage: "https://images.unsplash.com/photo-1624397640150-f823dc94073e?q=80&w=2670&auto=format&fit=crop"
    },
    {
        slug: "castres",
        name: "Castres",
        ...
        zip: "81100",
        tier: 'STRATEGIC',
        heroImage: "https://images.unsplash.com/photo-1611348586804-61bf6c080437?q=80&w=2670&auto=format&fit=crop"
    },
    {
        slug: "mont-de-marsan",
        name: "Mont-de-Marsan",
        ...
        zip: "40000",
        tier: 'STRATEGIC',
        heroImage: "https://images.unsplash.com/photo-1605980776566-0486c3ac7617?q=80&w=2670&auto=format&fit=crop"
    },
    {
        slug: "dax",
        name: "Dax",
        ...
        zip: "40100",
        tier: 'STRATEGIC',
        heroImage: "https://images.unsplash.com/photo-1599740831464-5778a48ef72a?q=80&w=2670&auto=format&fit=crop"
    }
];
...
export function getTargetAsCityConfig(slug: string): CityConfig | undefined {
    ...
    const priceDesc = "Étude Thermique & Devis Gratuit";

    const title = `Installateur Pompe à Chaleur ${target.name} | Devis & Aides RGE`;
    const uniqueDescription = `Trouvez votre installateur RGE de pompe à chaleur à ${target.name} (${target.zip}). Économisez jusqu'à 70% sur votre chauffage. Devis gratuit sous 24h.`;
    const uniqueMetaDescription = `Installation pompe à chaleur air-eau et air-air ${target.name}. Devis gratuit sous 24h avec des installateurs RGE QualiPAC. MaPrimeRénov' déduite.`;

    return {
        slug: target.slug,
        city: target.name,
        name: `PAC ${target.name}`,
        domain: `expertpompeachaleur.com/ville/${target.slug}`,
