...
export default function SchemaJSON({ type, site, breadcrumbItems, faqSegment }: SchemaJSONProps) {
    ...
    const baseUrl = "https://www.expertpompeachaleur.com";

    if (type === "LocalBusiness" && site) {
        const canonicalUrl = site.slug === 'home' || site.slug === 'expertpompeachaleur.com' || site.slug === 'www.expertpompeachaleur.com'
            ? baseUrl
