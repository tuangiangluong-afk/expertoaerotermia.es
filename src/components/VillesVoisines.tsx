            ...
            <div className="container mx-auto px-4 max-w-6xl">
                <div className="text-center mb-8">
                    <h2 className="text-2xl font-bold text-slate-900">
                        Instalación de aerotermia cerca de {cityName}
                    </h2>
                    <p className="text-slate-600 mt-2">
                        Nuestros instaladores certificados también trabajan en estas ciudades de la provincia de {department}.
                    </p>
                </div>
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                    {displayNeighbors.map(city => (
                        <Link
                            ...
                            title={`Instalación de aerotermia en ${city.name}`}
                        >
                            {city.name}
                        </Link>
                    ))}
