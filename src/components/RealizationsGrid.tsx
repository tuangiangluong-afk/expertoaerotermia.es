            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold mb-4">
                        Dernières installations en <span className="text-sky-500">Île-de-France</span>
                    </h2>
                    ...
                    {projects.map((proj, i) => (
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 p-6 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                                <div className="text-sky-400 text-xs font-bold uppercase tracking-wider mb-1 flex items-center gap-2">
