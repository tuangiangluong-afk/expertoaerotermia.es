...
export default function SimulatorWidget() {
    return (
        <div className="bg-white p-6 rounded-2xl shadow-xl border border-sky-100 ring-1 ring-sky-500/10">
            ...
            <div className="space-y-3 mb-6">
                <div className="flex items-center p-3 border rounded-lg bg-slate-50 cursor-pointer hover:border-sky-500 hover:bg-sky-50 transition-colors">
            ...
            <a href="/#simulateur" className="block w-full text-center bg-sky-600 hover:bg-sky-700 text-white font-bold py-3 px-4 rounded-xl shadow-lg hover:shadow-sky-500/25 transition-all">
                Comparer les devis
            </a>
