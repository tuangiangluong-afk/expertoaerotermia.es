        ...
        <section id="grants-calculator" className="py-16 lg:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row gap-12 items-center">
                ...
                <div className="flex-1 flex flex-col gap-6">
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 bg-sky-50 text-sky-600 px-3 py-1.5 rounded-full text-sm font-bold w-fit">
                    ...
                    <div className="flex flex-col gap-4 mt-4">
                        ...
                        <div className="flex gap-4 p-4 rounded-xl bg-white border border-slate-200 shadow-sm">
                            <div className="bg-sky-100 text-sky-600 h-12 w-12 rounded-lg flex items-center justify-center shrink-0">
                    ...
                    <button
                        ...
                        className="inline-flex items-center text-sky-600 font-bold hover:underline mt-4"
                    >
                    ...
                    <div className="relative w-full max-w-md bg-white rounded-2xl p-8 shadow-xl border border-slate-100">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex justify-between items-center pt-2">
                                ...
                                <span
                                    className={`text-3xl font-black text-sky-600 transition-all duration-300 ${isVisible ? "scale-110" : ""
                                        }`}
                                >
