...
const testimonials: Testimonial[] = [
    {
        quote: "L'outil de comparaison m'a fait gagner des heures. J'ai reçu 3 devis en 24h et l'installation de ma pompe à chaleur Air-Eau s'est déroulée à merveille. Les primes CEE et MaPrimeRénov' ont été directement déduites.",
        name: "Marc Dubreuil",
        location: "Lyon",
    ...
    {
        quote: "Très recommandé ! L'installateur RGE QualiPAC était très professionnel. Ma chaudière fioul a été remplacée en 2 jours, et les économies de chauffage sont déjà visibles sur mes factures.",
