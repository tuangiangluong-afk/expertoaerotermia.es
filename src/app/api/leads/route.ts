...
export async function POST(request: Request) {
    try {
        ...
        const consentUrl = body.consentUrl || refererUrl || "https://" + (body.domain || "expertoaerotermia.es");
        ...
        if (currentCountry === 'FR') { // Only route to ViteUnDevis for French leads
            ...
            const vudPayload = {
                ...
                cat_id: '164',
                site_name: domain || 'expertoaerotermia.es',
        ...
        const leadPayload: any = {
            ...
            tenant_id: domain || 'expertoaerotermia.es',
