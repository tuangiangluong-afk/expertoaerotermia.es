...
export const metadata: Metadata = {
    title: "Guías y Consejos de Aerotermia | Expert Pompe à Chaleur",
    description: "Aprenda todo sobre el funcionamiento y precio de la aerotermia.. Guides, conseils et astuces de nos artisans certifiés RGE QualiPAC.",
};
            ...
            <main className="container mx-auto px-4 py-16 pt-32">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-extrabold mb-4 tracking-tight">
                        Guías y Consejos sobre Aerotermia
                    </h1>
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                        Guías de ahorro y consejos prácticos para optimizar su sistema de calefacción.</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {guides.map((guide: any) => (
                        <Link
                            ...
                            className="group bg-white rounded-2xl p-6 shadow-sm border border-slate-200 hover:shadow-xl hover:border-sky-200 transition-all duration-300 flex flex-col h-full"
                        >
                            <div className="mb-4">
                                <span className="inline-flex items-center text-xs font-bold text-sky-700 bg-sky-50 px-2 py-1 rounded-md uppercase tracking-wider mb-3">
                                    {guide.category || 'Guide'}
                                </span>
                                <h2 className="text-xl font-bold group-hover:text-sky-600 transition-colors line-clamp-2">
                                    {guide.title}
                                </h2>
                            </div>
                            ...
                            <div className="flex items-center justify-between text-sm text-slate-400 mt-auto pt-4 border-t border-slate-100">
                                ...
                                <span className="flex items-center gap-1 group-hover:translate-x-1 transition-transform text-sky-600 font-medium">
