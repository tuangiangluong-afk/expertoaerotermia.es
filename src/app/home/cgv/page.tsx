        ...
        <div className="min-h-screen bg-slate-50 font-sans text-neutral-900">
            ...
            <main className="container mx-auto max-w-3xl px-4 py-12 lg:py-20">
                ...
                <div className="prose prose-neutral prose-lg max-w-none">
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        <h2 className="mb-4 text-2xl font-bold text-sky-900">2. Solicitudes de Presupuesto y Tarifas</h2>
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        <h2 className="mb-4 text-2xl font-bold text-sky-900">3. Responsabilité</h2>
                        <p>
                    ...
                    <div className="mb-8 rounded-2xl border-2 border-sky-200 bg-sky-50 p-8 shadow-sm">
                        <h2 className="mb-4 text-2xl font-bold text-sky-900">4. Nature du Service - Mise en Relation</h2>
                        <p className="font-semibold text-sky-800">
                            Expert Pompe à Chaleur est une <strong>plateforme de mise en relation technique</strong> entre les utilisateurs et des installateurs de pompes à chaleur indépendants.
                        </p>
                        <p className="mt-4 text-sky-700">
                            <strong>Expert Pompe à Chaleur n&apos;est pas une entreprise d&apos;installation ou de travaux.</strong> Les prestations de pose sont effectuées par des professionnels indépendants ou des sociétés tierces, dûment certifiés RGE et assurés.
                        </p>
                        <p className="mt-4 text-sky-700">
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        <h2 className="mb-4 text-2xl font-bold text-sky-900">5. Loi Applicable</h2>
                        <p>
