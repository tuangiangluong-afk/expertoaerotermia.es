        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-sky-500 selection:text-white">
            ...
            <section className="pt-32 pb-12 lg:pt-40 lg:pb-20 px-6 bg-white overflow-hidden relative">
                ...
                <div className="mx-auto max-w-4xl text-center relative z-10">
                    <span className="inline-flex items-center rounded-full bg-sky-50 border border-sky-200 px-4 py-1.5 text-xs font-bold text-sky-700 mb-8 tracking-widest uppercase">
                        <Zap size={12} className="mr-2 fill-sky-600" />
                        Service National
                    </span>
                    <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-6 text-slate-900">
                        Un projet de <span className="text-sky-500">pompe à chaleur</span> ?
                    </h1>
            ...
            <section className="pb-20 px-6">
                <div className="mx-auto max-w-6xl">
                    <div className="grid md:grid-cols-3 gap-8 mb-16 -mt-8">
                        {/* Card 1: Commercial */}
                        <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100 hover:border-sky-200 transition text-center group">
                            <div className="mx-auto w-14 h-14 bg-sky-50 rounded-2xl flex items-center justify-center mb-6 text-sky-600 group-hover:scale-110 transition duration-300">
                                <Phone size={28} />
                            </div>
                            ...
                            <span className="text-lg font-bold text-sky-600">Via le formulaire ci-dessous</span>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100 hover:border-sky-200 transition text-center group">
                            ...
                            <span className="font-bold text-sky-600">Via le formulaire ci-dessous</span>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100 hover:border-sky-200 transition text-center group">
                            ...
                            <p className="font-bold text-slate-900">Expert Pompe à Chaleur</p>
                        </div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-5 gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="p-6 bg-sky-50 rounded-2xl border border-sky-100">
                                <h4 className="font-bold text-sky-900 mb-2">Vous êtes installateur ?</h4>
                                <p className="text-sm text-sky-700 mb-4">Rejoignez notre réseau de professionnels RGE QualiPAC sur toute la France.</p>
                                <Link href="#form" className="text-sm font-bold text-sky-600 hover:underline flex items-center gap-1">
                        ...
                        <div id="form" className="lg:col-span-3 bg-white rounded-3xl p-8 md:p-10 shadow-2xl border border-slate-100">
                            ...
                            <ContactForm domain="expertpompeachaleur.com" city="Hub National" theme={getTheme('national')} />
                        </div>
                    </div>
                </div>
            </section>
