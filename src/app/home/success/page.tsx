...
export async function generateMetadata(): Promise<Metadata> {
    const domain = "expertpompeachaleur.com";
    const config = getSiteConfig(domain);

    return {
        title: `Demande reçue | ${config?.name || "Expert Pompe à Chaleur"}`,
...
const timelineSteps: TimelineStep[] = [
    {
        ...
        timing: "Sous 24h",
        description: "Nous validerons les spécificités de votre habitation, de votre isolation et de votre chauffage actuel.",
        active: true,
    },
    {
        icon: <Wrench className="w-5 h-5" />,
        title: "Visite technique RGE",
        timing: "Évaluation thermique",
        description: "Un technicien RGE QualiPAC étudiera la configuration de vos émetteurs (radiateurs ou plancher chauffant) et de l'unité extérieure.",
        active: false,
    },
    {
...
export default async function SuccessPage({ searchParams }: PageProps) {
    ...
    const domain = "expertpompeachaleur.com";
    const config = getSiteConfig(domain);
    const siteName = config?.name || "Expert Pompe à Chaleur";
            ...
            <main className="max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-16">
                ...
                <div className="flex flex-col items-center justify-center text-center mb-12">
                    ...
                    <p className="text-lg text-slate-600 max-w-xl">
                        Votre demande d&apos;étude thermique pour pompe à chaleur a bien été enregistrée. Un conseiller Expert Pompe à Chaleur
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-7">
                        ...
                        <div className="mt-6 flex flex-wrap justify-center gap-8 opacity-60">
                            {["QUALIPAC", "RGE", "DECENNALE"].map((badge) => (
                        ...
                        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-1 shadow-lg text-white overflow-hidden relative">
                            ...
                            <div className="p-6 md:p-8 relative z-10">
                                ...
                                <h3 className="text-xl md:text-2xl font-bold mb-2">
                                    Subventions & Économies
                                </h3>
                                <p className="text-slate-300 text-sm mb-6">
                                    Consultez nos dossiers d&apos;informations complets sur les aides de l&apos;État pour l&apos;installation d&apos;une pompe à chaleur.
                                </p>
                                <Link
                                    href="/guides"
                        ...
                        <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm flex flex-col sm:flex-row gap-5 items-center">
                            ...
                            <div className="flex-1 text-center sm:text-left">
                                ...
                                <p className="text-slate-500 text-sm mb-3">
                                    Recommandez un proche intéressé par le remplacement de sa chaudière et recevez un chèque cadeau lors de son installation.
                                </p>
